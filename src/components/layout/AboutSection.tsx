        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 relative">
             <div className="relative w-80 h-80 sm:w-96 sm:h-96 mx-auto">
               ...
               {/* Badge */}
               <div className="absolute bottom-4 left-1/2 -translate-x-1/2 lg:left-0 lg:translate-x-0 bg-primary text-white p-5 rounded-tl-2xl rounded-br-2xl shadow-xl flex items-center gap-3 min-w-[200px]">
                 <span className="text-4xl font-display font-bold">10+</span>
                 <div className="text-xs font-bold leading-tight uppercase">
                   Năm kinh nghiệm <br/> Đồng hành cùng nhà nông
                 </div>
               </div>
             </div>
          </div>
