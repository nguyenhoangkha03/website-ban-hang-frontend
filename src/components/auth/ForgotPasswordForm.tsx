        ...
        <form onSubmit={phoneForm.handleSubmit(onCheckPhone)} className="space-y-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-lg border outline-none mt-1 transition-all ${phoneForm.formState.errors.phone ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:ring-2 focus:ring-green-500'
                }`}
